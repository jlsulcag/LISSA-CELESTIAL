...
public class Laboratorio implements java.io.Serializable {
    ...
    public Laboratorio(int idlaboratorio, String denominacion, boolean estado) {
        this.idlaboratorio = idlaboratorio;
        this.denominacion = denominacion;
        this.estado = estado;
    }

    public Laboratorio(int idlaboratorio, String denominacion, boolean estado, Set<Producto> productos) {
        this.idlaboratorio = idlaboratorio;
        this.denominacion = denominacion;
        this.estado = estado;
