...
public class Medico implements java.io.Serializable {
    ...
    public Medico(int idMedico, Persona persona, TipoMedico tipoMedico, Boolean estado, Date fechaReg, String codigoColegiatura, Set<MedicoEspecialidad> medicoEspecialidads, Set<ItemsComprobante> itemsComprobantesForIdMedicoDeriva, Set<ItemsComprobante> itemsComprobantesForIdMedicoAtiende, Set<Cita> citas, Set<MedicoDerivaAtiende> medicoDerivaAtiendes) {
        this.idMedico = idMedico;
        this.persona = persona;
        this.tipoMedico = tipoMedico;
        this.estado = estado;
