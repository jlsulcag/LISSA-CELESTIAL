...
public class JIF_BuscarHistoriaClinica extends javax.swing.JInternalFrame {
    ...
    private ModeloAtencion oModeloAtencion = null;
    ...
    private ArrayList<Atencion> listAtenciones = null;
    ...
    public JIF_BuscarHistoriaClinica(JF_Principal root) {
        ...
        oModeloAtencion = new ModeloAtencion();
...
//        }
    ...
    private void tblAtencionesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAtencionesMouseReleased
        if(tblAtenciones.getRowSelectionAllowed() && tblAtenciones.getSelectedRow() != -1){
            oAtencion = oModeloAtencion.get(tblAtenciones.getSelectedRow());
       }
    ...
    private void cargarDatosPersona() {
        switch (getInvocador()) {
            case JIF_REGISTRAR_DIAGNOSTICO:
                root.jifRegistrarDiagnostico.cargarDatosHistoriaClinica(beanTabla);
                break;
...
//            for (Atencion atencion : beanTabla.getAtencions()) {
...
//    private Atencion obtenerAtencion() {
//        oAtencionBl = new AtencionBl();
//        return oAtencionBl.buscarUltimaAtencion(beanTabla.getIdhistoriaclinica());
//    }

    private void cargarHistorial() {
        root.jifHistoriaClinica.cargarDatosHistorial(oAtencion);
    }
}
