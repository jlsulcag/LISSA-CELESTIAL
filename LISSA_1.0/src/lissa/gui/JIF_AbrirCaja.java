...
public class JIF_AbrirCaja extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jdcFechaApertura.setDateFormatString("dd/MM/yyyy");
        ...
        cbxAreaCaja.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jsHora, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void inicioHora() {
        //fecha de sistema
        jdcFechaApertura.setCalendar(calendar);
...
//        fecha.setEditor(new JSpinner.DateEditor(fecha, "dd/MM/yyyy"));
    ...
    private int aperturarCaja() {
        ...
        caja.setHoraApertura(hour.format(jsHora.getValue()));

        caja.setEstado("ABIERTO");
        if (txfSaldoInicial.getText().trim().equals("")) {
            caja.setSaldoInicial(new BigDecimal("0.00"));
        } else {
            caja.setSaldoInicial(new BigDecimal(txfSaldoInicial.getText().trim()));
        }
