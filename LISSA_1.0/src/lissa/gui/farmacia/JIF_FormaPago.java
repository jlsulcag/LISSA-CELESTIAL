...
public class JIF_FormaPago extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txfDescComprobante = new javax.swing.JTextField();
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Descripción comprobante seguros"));

        javax.swing.GroupLayout jPanel4Layout = new javax.swing.GroupLayout(jPanel4);
        jPanel4.setLayout(jPanel4Layout);
        jPanel4Layout.setHorizontalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(txfDescComprobante)
        );
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(5, 5, 5)
                .addComponent(txfDescComprobante, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (cbxModalidadPago.getSelectedItem().toString().equals("CONTADO") || cbxModalidadPago.getSelectedItem().toString().equals("CREDITO")) {
            root.jifRegVentas.enviaCuentasxcobrar(oCuentaxcobrar, totalAPagar);
            ...
            if (cbxBeneficio.getSelectedItem().toString().equals("FONDO PREVISION")) {
                if (isDatosValidosFps()) {
                    ...
                    root.jifRegVentas.enviaCuentasxcobrar(oCuentaxcobrar, totalAPagar, oHistorialAtencionFps);
                    this.doDefaultCloseAction();
                } else {
    ...
    private javax.swing.JTextField txfDescComprobante;
    ...
    private Cuentaxcobrar agregarCuentasxcobrar() {
        ...
        oCuentaxcobrar.setEstado("ACT");
        oCuentaxcobrar.setFechaPago(new Date());
        oCuentaxcobrar.setMontoPagado(BigDecimal.ZERO);
        oCuentaxcobrar.setIdSeguro(cbxSeguro.getSelectedIndex() > 0 ? ((SeguroVida) cbxSeguro.getSelectedItem()).getIdSeguroVida() : 0);
        oCuentaxcobrar.setIdBeneficio(cbxBeneficio.getSelectedIndex() > 0 ? ((Beneficio) cbxBeneficio.getSelectedItem()).getIdbeneficio() : 0);
        oCuentaxcobrar.setIdFondops(oFondoSolidaridad != null ? oFondoSolidaridad.getIdFondoSolidaridad() : 0);
        ...
        oCuentaxcobrar.setDescripcionSeguros(txfDescComprobante.getText().trim().toUpperCase());
        oCuentaxcobrar.setIdFormapago(cbxModalidadPago.getSelectedIndex() > 0 ? ((FarFormaPago) cbxModalidadPago.getSelectedItem()).getIdformapago() : 0);
    ...
    private void buscarDatosUltimoRegistroFondo() {
