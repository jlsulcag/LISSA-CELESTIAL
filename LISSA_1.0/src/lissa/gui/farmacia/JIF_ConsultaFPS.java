...
public class JIF_ConsultaFPS extends javax.swing.JInternalFrame {
    ...
    private void btnGuardarFondoPrevActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarFondoPrevActionPerformed
        ...
        if (oFondoPrevisionTemp != null) {
            ...
            //buscar fondo pñor fecha de pago
            if(existeFondo()){
            ...
            //verificar si ya esta activo su servicio fondo
            //si no existe se registra
            // de lo contrario ya no se registra
//            if (oFondoSolidaridad != null) {
//                oServiciosFondoSolidaridad = registrarServicioFondoSolidaridad(oFondoSolidaridad);
//                if (oServiciosFondoSolidaridad.getIdserviciosfs() != 0) {
...
//                listarAtencionesFondo(oFondoSolidaridad);
    ...
    private void consultaFondoLissa() {
        ...
        if (oPersona != null) {
            listfs = oBlFondoPrevision.listar(oPersona.getIdPersona());
            if (!listfs.isEmpty()) {
