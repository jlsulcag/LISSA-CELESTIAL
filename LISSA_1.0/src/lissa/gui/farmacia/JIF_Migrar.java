...
public class JIF_Migrar extends javax.swing.JInternalFrame {
    ...
    private void registrarAlmacen() {
        ...
        int cant = txfAlmacen.getText().trim().equals("")?0:Integer.parseInt(txfAlmacen.getText().trim());
        oAlmacenProducto.setStockActual(cant);
        oAlmacenProducto.setFechaRegistro(new Date());
        oAlmacenProducto.setEstado(Boolean.TRUE);
        oAlmacenProducto.setPrecioVenta(BigDecimal.ZERO);
        oAlmacenProducto.setPrecioMin(BigDecimal.ZERO);
        oAlmacenProducto.setPrecioMax(BigDecimal.ZERO);
    ...
    private void registrarFarmacia() {
        ...
        int cant = txfFarmacia.getText().trim().equals("")?0:Integer.parseInt(txfFarmacia.getText().trim());
        oAlmacenProducto.setStockActual(cant);
        oAlmacenProducto.setFechaRegistro(new Date());
        oAlmacenProducto.setEstado(Boolean.TRUE);
        oAlmacenProducto.setPrecioVenta(new BigDecimal(txfPrecio.getText().trim()));
        oAlmacenProducto.setPrecioMin(new BigDecimal(txfPrecio.getText().trim()));
        oAlmacenProducto.setPrecioMax(new BigDecimal(txfPrecio.getText().trim()));
        oAlmacenProducto = oAlmacenProductoBl.registrar(oAlmacenProducto);
    }    
